...
public interface AgentConfig {
	...
	public static int blooepressure_dev_config_id = Nomenclature.MDC_PRESS_BLD_NONINV;
	public static int oximeter_dev_config_id = Nomenclature.MDC_PULS_OXIM_SAT_O2;
