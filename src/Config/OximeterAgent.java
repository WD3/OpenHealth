...
public class OximeterAgent extends Specialization{
	...
	public void addMeasure(int value){
		Measures.add(generateMeasure(value));
	}
	private DeviceConfig generateTestDeviceConfig(){
		...
		dev_conf.setPhdId(AgentConfig.oximeter_dev_config_id);
	...
	private Map<HANDLE,Object> generateMeasure(int value){
		...
		bnv.setValue(new SFLOAT_Type(value));
